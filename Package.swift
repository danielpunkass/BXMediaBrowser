...
let package = Package(
    ...
    dependencies:
    [
        .package(url:"https://github.com/boinx/BXSwiftUtils.git", .branch("master")),
        .package(url:"https://github.com/boinx/BXSwiftUI.git", .branch("master")),
        .package(url:"https://github.com/peterb180369/OAuth2.git", .branch("master")),
    ],
